...
絕大部分從事**客製型軟體系統**（taylor-made software system）或軟體專案開發的人員都有類似上述的經驗，很遺憾，50多年過去了，這種情況並沒有太大改變，也沒有完善的解決方案。或許正如布魯克斯所說的，在軟體工程領域，沒有銀彈（No Silver Bullet—Essence and Accidents of Software Engineering）。[^3]
